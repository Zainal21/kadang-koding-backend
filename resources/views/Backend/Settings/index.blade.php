        ...
        <div class="col-6 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{url('/site/admin/settings/'. $stg->id)}}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-control" id="" cols="30"
                                rows="10">{{$stg->deskripsi}}</textarea>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {{asset('admin/assets/images/blog/post-thumb1.jpg')}}
                     @endif" width="400px" height="200px" alt="">
                    </div>
                    <div class="form-group">
                        <label for="">Cover Sebelumnya</label>
                        <img src="@if ($stg->Hero_cover)
