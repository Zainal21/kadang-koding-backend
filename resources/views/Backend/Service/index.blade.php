                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <form action="{{url('/site/admin/service/delete/'. $item->id)}}"  class="d-inline" method="POST">
                                                @csrf
                                                @method('delete')
                                                <button type="submit" class="btn btn-danger btn-sm my-2"><i class="ti-trash"></i></button>
                                            </form>
                                        <a href="{{url('/site/admin/service/edit/'. $item->id)}}" class="btn btn-info btn-sm my-2"><i class="ti-pencil"></i></a></td>
                                        </tr>
                                        @endforeach     
                                    </tbody>
                                </table>
