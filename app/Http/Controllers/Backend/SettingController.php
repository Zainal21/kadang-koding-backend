...
class SettingController extends Controller
{
    ...
    public function update(Request $req)
    {
        ...
        $data->logo = $req->file('logo') == "" ? 'uploads/setting/logo/default.jpg' : $req->file('logo')->store('uploads/setting/logo', 'public');
        if($data->Hero_Cover){
            Storage::delete('public/'.$data->Hero_Cover);
        }
        $data->Hero_Cover =  $req->file('Hero_Cover') == "" ? 'uploads/setting/Hero/default.jpg' :  $req->file('Hero_Cover')->store('uploads/setting/hero', 'public');
        $data->save();
